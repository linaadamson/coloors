...
const panelItems = document.querySelectorAll(".panel li");
const colors = document.querySelector(".colors");
let initialColors;

// EVENT LISTENERS
generateBtn.forEach((generateBtn) => {
...
function randomColors() {
  ...
  colorDivs.forEach((div, index) => {
    ...
    if (div.classList.contains("locked")) {
      ...
      // Add the random color to empty initialColor array
...
function mobileMenu() {
  panel.classList.toggle("nav-active");
  colors.classList.toggle("blur");
